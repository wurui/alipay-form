            ...
            <div class="auto-wrapper">
                <xsl:choose>
                    <xsl:when test="data/error">
                        <h3 class="error">
                            错误: <xsl:value-of select="data/error"/>
                        </h3>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <div class="orderwrap">
                            ...
                            <table class="order-info" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <th>商品</th>
                                        <td><xsl:value-of select="data/order/title"/></td>
                                    </tr>
                                    <tr>
                                        <th>金额</th>
                        ...
                        <div class="wxpaybox">
                            <div class="alipay">
                                <br/>
                                <img width="75" alt="　" src="http://i.oxm1.cc/uploads/git/wurui/img/2ag7uubwmTj34i79t6Rl9ypA4le-940.png"/>
                            </div>
                            <div id="bottomtip">
                                正在跳转支付宝收银台...
                            </div>
